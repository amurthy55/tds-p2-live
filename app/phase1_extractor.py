...
def identify_quiz_components(raw_pages: list) -> dict:
    ...
    # collect student email if mentioned in content or URLs
    student_email = None
    ...
    for p in raw_pages:
        ...
        # extract emails
        for email in re.findall(r"[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,}", cleaned_text + url):
    ...
    return {
        ...
        # evaluator_feedback is injected by main.py during retries
    }
